@php
    ...
    $message = $exception?->getMessage() ?: 'Ocorreu um erro inesperado. Tente novamente mais tarde.';
@endphp
...
<div class="error-block">
    <div class="error-code font-audiowide text-6xl sm:text-7xl font-bold">{{ $code }}</div>
