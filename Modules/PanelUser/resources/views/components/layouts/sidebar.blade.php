                    ...
                    @if($isPro && Route::has('core.dashboard'))
                        <a href="{{ route('core.dashboard') }}"
                           class="{{ $navItemClass }} {{ request()->routeIs('core.dashboard') ? $navItemActiveClass : '' }}">
                            <x-icon name="gauge" style="solid" class="w-5 h-5 shrink-0 transition duration-75 {{ request()->routeIs('core.dashboard') ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300' }}" />
                ...
                <li>
                    @if($isPro && Route::has('core.invoices.index'))
                        <a href="{{ route('core.invoices.index') }}"
                           class="{{ $navItemClass }} {{ request()->routeIs('core.invoices.*') ? $navItemActiveClass : '' }}">
                            <x-icon name="file-invoice-dollar" style="solid" class="w-5 h-5 shrink-0 transition duration-75 {{ request()->routeIs('core.invoices.*') ? 'text-primary-600 dark:text-primary-400' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300' }}" />
