    ...
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden border border-gray-100 dark:border-gray-700">
            <div class="p-8 sm:p-10 text-center">
                ...
                <!-- Icon -->
                <div class="mx-auto h-24 w-24 bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-full flex items-center justify-center mb-6 ring-8 ring-emerald-50 dark:ring-emerald-900/10">
                    <x-icon name="bullseye" style="duotone" class="h-10 w-10 text-emerald-600 dark:text-emerald-500" />
                </div>

                <!-- Headline -->
                <h2 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-4">
                    Conquiste Mais Objetivos
                </h2>
                <p class="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
                    Seu plano atual permite apenas <strong>1 meta financeira</strong>. Sonhe alto e realize mais com o <strong>Vertex Pro</strong>.
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-10">
                    ...
                    <div class="bg-gray-50 dark:bg-slate-700/50 rounded-xl p-6 border border-gray-200 dark:border-gray-600 opacity-75">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white mb-2">1 Meta</div>
                        <ul class="text-sm text-gray-600 dark:text-gray-300 space-y-2 mt-4 text-left">
                            <li class="flex items-center text-red-500">
                                <x-icon name="xmark" style="solid" class="w-4 h-4 mr-2" /> Sem projeções automáticas
                            </li>
                            <li class="flex items-center text-red-500">
                                <x-icon name="xmark" style="solid" class="w-4 h-4 mr-2" /> Acompanhamento limitado
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-gradient-to-b from-primary/5 to-transparent rounded-xl p-6 border-2 border-primary relative overflow-hidden">
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Metas Ilimitadas</div>
                        <ul class="text-sm text-gray-600 dark:text-gray-300 space-y-2 mt-4 text-left">
                            <li class="flex items-center text-emerald-600 dark:text-emerald-400">
                                <x-icon name="check" style="solid" class="w-4 h-4 mr-2" /> <strong>Crie infinitos objetivos</strong>
                            </li>
                            <li class="flex items-center text-emerald-600 dark:text-emerald-400">
                                <x-icon name="check" style="solid" class="w-4 h-4 mr-2" /> Previsão de conclusão
                            </li>
                            <li class="flex items-center text-emerald-600 dark:text-emerald-400">
                                <x-icon name="check" style="solid" class="w-4 h-4 mr-2" /> Dicas inteligentes
                            </li>
                        </ul>
                    </div>
                </div>
