                ...
                <div class="border-t border-gray-200 dark:border-slate-700 pt-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <textarea name="meta_description" id="meta_description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-slate-700 dark:text-white">{{ $post->meta_description }}</textarea>
                        ...
                        <div>
                            ...
                            @if($post->og_image)
                                <img src="{{ asset($post->og_image) }}" alt="OG Image" class="h-20 object-cover mb-2 rounded">
                            @endif
