...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Mensagens de validação em português do Brasil para o Vertex Contas.
    |
    */
    ...
    'password' => [
        ...
        'symbols' => 'A senha deve conter pelo menos um caractere especial (ex.: @ # $ % & *).',
        'uncompromised' => 'Esta senha apareceu em um vazamento de dados. Por favor, escolha outra senha.',
    ],
    ...
    'unique' => 'Este :attribute já está em uso. Por favor, escolha outro.',
    ...
    'custom' => [
        ...
        'g-recaptcha-response' => [
            'required' => 'Complete a verificação de segurança antes de continuar.',
        ],
    ],
    ...
    'attributes' => [
        ...
        'username' => 'usuário',
        'role' => 'função',
        'g-recaptcha-response' => 'verificação de segurança (reCAPTCHA)',
    ],
